"""
io-gita ROS2 Debug Node — Live Diagnostics on Robot
=====================================================
...
Launch alongside the main iogita_zone_node:
    ros2 run iogita iogita_debug_node

Subscribes to all /iogita/* topics and logs everything.
Also provides a /iogita/debug/run_diagnostic service.
...
# ── This file is a TEMPLATE for ROS2 integration ──
# ── It shows the exact node structure and topic names ──
# ── Modify the marked sections for your ROS2 workspace ──
