...
- Contact: ai.meharbansingh@gmail.com for production license.
...
def _check_license():
    ...
    if today > expiry:
        raise LicenseExpiredError(
            ...
            f"\n"
            f"  Contact ai.meharbansingh@gmail.com for:\n"
    ...
    if days_left <= 14:
        print(f"[io-gita] WARNING: Evaluation license expires in {days_left} days "
              f"({expiry}). Contact ai.meharbansingh@gmail.com to renew.")
    return days_left
