#!/usr/bin/env python
"""
io-gita Zone Identification Node — ROS1 + ROS2 Compatible
===========================================================
...
Standalone (no ROS — for testing):
    python iogita_zone_node.py
...
# ROS imports are deferred — auto-detected at runtime (see amcl_hook_example.py)
# No need to uncomment anything.
